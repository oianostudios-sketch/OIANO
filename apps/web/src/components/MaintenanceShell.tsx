...
export default function MaintenanceShell({children,toolbar}:{children:ReactNode;toolbar?:ReactNode;title?:string;eyebrow?:string}){
  ...
  return <main className="min-h-screen bg-[#060708] text-white md:pl-[238px]">
    ...
    <header className="sticky top-0 z-20 border-b border-white/[.065] bg-[#060708]/90 backdrop-blur-xl">
