    ...
    <main className="min-h-screen bg-studio-bg px-5 py-10 text-zinc-100 md:px-8">
      <div className="mx-auto max-w-6xl">
        ...
        <section className="mt-7 grid gap-3 lg:grid-cols-[1.2fr_.8fr]">
          <article className="rounded-3xl border border-white/[.065] bg-studio-surface p-6 md:p-8">
