...
export default function ContributionInboxPage() {
  ...
  return <main className="min-h-screen bg-[#070809] px-5 py-10 text-zinc-100 md:px-8"><div className="mx-auto max-w-6xl">
    ...
    {!isLoading && !isError && <section aria-label="Contribution record summary" className="mt-6 grid grid-cols-2 gap-3 lg:grid-cols-4"><article className="rounded-2xl border border-white/[.06] bg-[#0c0e10] p-4"><Clock3 size={14} className="text-violet-300"/><p className="mt-4 text-2xl">{pending.length}</p><p className="mt-1 text-[8px] font-mono uppercase text-zinc-700">Pending decisions</p></article><article className="rounded-2xl border border-white/[.06] bg-[#0c0e10] p-4"><FolderKanban size={14} className="text-[#5A9BCB]"/><p className="mt-4 text-2xl">{active.length}</p><p className="mt-1 text-[8px] font-mono uppercase text-zinc-700">Active projects</p></article><article className="rounded-2xl border border-white/[.06] bg-[#0c0e10] p-4"><FileCheck2 size={14} className="text-emerald-400"/><p className="mt-4 text-2xl">{confirmedCredits.length}</p><p className="mt-1 text-[8px] font-mono uppercase text-zinc-700">Confirmed credits</p></article><article className="rounded-2xl border border-white/[.06] bg-[#0c0e10] p-4"><Music2 size={14} className="text-amber-300"/><p className="mt-4 text-2xl">{linkedSessions}</p><p className="mt-1 text-[8px] font-mono uppercase text-zinc-700">Linked sessions</p></article></section>}
